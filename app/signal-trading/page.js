...
export default function SignalTradingPage() {
  ...
  const fetchSignals = async () => {
    try {
      ...
      if (result.success) {
        setSignals(result.data?.signals || result.signals || [])
      } else {
    ...
    try {
      ...
      if (result.success) {
        addNotification({
          ...
          message: `Generated ${result.data?.signals?.length || 0} new signals!`,
          duration: 5000
        })
      ...
      <MainLayout>
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Signal Trading</h1>
