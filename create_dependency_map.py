#!/usr/bin/env python3
"""
Create a visual dependency map for the EmergentTrader project
"""
...
def create_dependency_map():
    """Create a visual dependency map from the analysis results"""
    
    # Load the analysis results
    with open('PROJECT_FILE_USAGE_ANALYSIS.json', 'r') as f:
        analysis = json.load(f)
    
    # Create dependency map content
    map_content = """# EmergentTrader - File Dependency Map
...
"""
    ...
    with open('PROJECT_DEPENDENCY_MAP.md', 'w') as f:
        f.write(map_content)
    
    print("Dependency map created: PROJECT_DEPENDENCY_MAP.md")
